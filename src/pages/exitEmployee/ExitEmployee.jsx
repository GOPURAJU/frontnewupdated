...
function ExitEmployee() {
  ...
  return (
    <>
    <div class="p-3 mb-2 bg-primary text-white" style={{color:"#1492E6"}}>RELEASE EMPLOYEE</div>
    <div  id="transfer-employee" className="container-sm ">
      ...
      <div className="form">
        ...
        <Button className="btn-signup px-2" type="submit" varient="success">
          submit
        </Button>{" "}
        <Button onClick={handleCancel}   className="px-2" variant="danger">
          Cancel
        </Button>
      </Form>
    </div>
